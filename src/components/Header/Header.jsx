...
const Header = (props) => {
    ...
    return (
        <header>
            <div className="logo">
                <svg width="40px" height="40px" viewBox="0 0 200 168" version="1.1" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="nav">
                <div className="nav__menu">
                    <span
                        className={`nav__menu__item ${menuItem === 'inbox' ? 'active' : ''}`}
                        onClick={() => {
                            setMenuItem('inbox')
                        }}>
                        Inbox
                    </span>
                    <MoreVertIcon className="nav__menu__separator" />
                    <span
                        className={`nav__menu__item ${menuItem === 'all_calls' ? 'active' : ''}`}
                        onClick={() => {
                            setMenuItem('all_calls')
                        }}>
                        All Calls
                    </span>
                    <MoreVertIcon className="nav__menu__separator" />
